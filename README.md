...
4. SCM_SECRET: *Optional. Do not include unless you have a special use case requiring it. These tokens are typically many-to-one SCM and are managed in the Semgrep UI.
