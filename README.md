...
- GET `https://github.example.com/api/v3/repositories/:id(\d+)/actions/secrets/public-key`
- GET `https://github.example.com/api/v3/repositories/:id(\d+)/branches`
- GET `https://github.example.com/api/v3/repositories/:id(\d+)/branches/:branch`
- GET `https://github.example.com/api/v3/repositories/:id(\d+)/collaborators/:username/permission`
...
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/check-runs`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/git/refs`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/issues/:number/comments`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/pulls/:number/comments`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/pulls/:number/comments/:comment_id/replies`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/statuses/:commit`
...
- PUT `https://github.example.com/api/v3/repositories/:id(\d+)/actions/secrets/SEMGREP_APP_TOKEN`
- PUT `https://github.example.com/api/v3/repositories/:id(\d+)/contents/.github/workflows/semgrep.yml`
...
- POST `https://github.example.com/api/v3/repos/:owner/:repo/git/commits`
- POST `https://github.example.com/api/v3/repos/:owner/:repo/git/trees`
- POST `https://github.example.com/api/v3/repos/:owner/:repo/pulls`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/git/blobs`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/git/commits`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/git/trees`
- POST `https://github.example.com/api/v3/repositories/:id(\d+)/pulls`
- PATCH `https://github.example.com/api/v3/repos/:owner/:repo/git/refs/*`
- PATCH `https://github.example.com/api/v3/repositories/:id(\d+)/git/refs/*`
...
inbound:
  bitbucket:
    ...
    allowCodeAccess: false # default is false, set to true to allow Semgrep to read file contents (and write them back for Code Autofix)
```
...
- POST `https://bitbucket.example.com/rest/api/latest/projects/:project/repos/:repo/pull-requests`
- POST `https://bitbucket.example.com/scm/:project/:repo/git-upload-pack`
- PUT `https://bitbucket.example.com/rest/api/latest/projects/:project/repos/:repo/browse/*`
<!-- EndAutogeneratedAllowList:Bitbucket.AllowCodeAccess -->

The `POST .../branches`, `PUT .../browse/*`, and `POST .../pull-requests` entries are what
Code Autofix uses to create a branch, commit a fix onto it, and open a pull request. Leave
`allowCodeAccess` unset if you do not want Semgrep writing to your repositories.
...
- GET `https://dev.azure.com/:namespace/_apis/hooks/subscriptions`
...
- POST `https://dev.azure.com/:namespace/_apis/hooks/subscriptions`
- PUT `https://dev.azure.com/:namespace/_apis/hooks/subscriptions/:subscriptionId`
...
- DELETE `https://dev.azure.com/:namespace/_apis/hooks/subscriptions/:subscriptionId`
...
- POST `https://dev.azure.com/:namespace/:project/_apis/git/repositories/:repo/pullRequests`
- POST `https://dev.azure.com/:namespace/:project/_apis/git/repositories/:repo/pushes`
