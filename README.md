...
- GET `https://bitbucket.example.com/rest/api/latest/scm/:project/:repo/info/refs`
- POST `https://bitbucket.example.com/rest/api/latest/projects/:project/repos/:repo/commit/:commit/builds`
- POST `https://bitbucket.example.com/rest/api/latest/scm/:project/:repo/git-upload-pack`
